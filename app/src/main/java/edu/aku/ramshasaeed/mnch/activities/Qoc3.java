...
public class Qoc3 extends AppCompatActivity implements RadioGroup.OnCheckedChangeListener {
    ...
    public void BtnContinue() {
        if (formValidation()) {
            ...
            if (UpdateDB()) {
                Toast.makeText(this, "Starting 4th Section", Toast.LENGTH_SHORT).show();
    ...
    private void SaveDraft() throws JSONException {
        ...
        qoc3.put("qc0301a", bi.qc0301aa.isChecked() ? "1" : bi.qc0301ab.isChecked() ? "2" : bi.qc0301a97.isChecked() ? "97" : "0");
        ...
        qoc3.put("qc0302a", bi.qc0302aa.isChecked() ? "1" : bi.qc0302ab.isChecked() ? "2" : bi.qc0302a97.isChecked() ? "97" : "0");
        ...
        qoc3.put("qc0303a", bi.qc0303aa.isChecked() ? "1" : bi.qc0303ab.isChecked() ? "2" : bi.qc0303a97.isChecked() ? "97" : "0");
        ...
        qoc3.put("qc0304a", bi.qc0304aa.isChecked() ? "1" : bi.qc0304ab.isChecked() ? "2" : bi.qc0304a97.isChecked() ? "97" : "0");
        ...
        qoc3.put("qc0305a", bi.qc0305aa.isChecked() ? "1" : bi.qc0305ab.isChecked() ? "2" : bi.qc0305a97.isChecked() ? "97" : "0");
