...
import edu.aku.ramshasaeed.mnch.contracts.UsersContract;
import edu.aku.ramshasaeed.mnch.contracts.UsersContract.UsersTable;
...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public static final String SQL_CREATE_USERS = "CREATE TABLE " + UsersContract.UsersTable.TABLE_NAME + "("
            ...
            + " );";
    public static final String DATABASE_NAME = "mnch.db";
    public static final String DB_NAME = DATABASE_NAME.replace(".", "_copy.");
    public static final String PROJECT_NAME = "MNCH-2018-2020";
